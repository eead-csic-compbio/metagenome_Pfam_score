...
![Barplot](data/entropies_matrix_entropies.tab_bar.png )
![Histogram](data/entropies_matrix_entropies.tab_entropy_hist.png )
![Heatmap](data/entropies_matrix_entropies.tab_hmap.png )
![Boxplot](data/entropies_matrix_entropies.tab_prof_box.png )
![Scatter](data/entropies_matrix_entropies.tab_scatter.png )


To get the names of each PFAM  use the following commands 
...
#Use the script pfam.terms.sh obtained from (https://github.com/Cantalapiedra/pfam_terms)
cd ../scripts
./pfam.terms.sh 

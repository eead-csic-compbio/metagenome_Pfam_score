...
echo "------------------------------------------------------------------"
echo "          Computing Mean Size legth (MSL) of input metagenomes"
echo "------------------------------------------------------------------"
...
for i in $inputdir/*.faa; do \
  ...
  cat $i.msl
  echo "Find out appropiate fragment size of classifiere (genF)"
 ...
 echo "Done computing MEBS final score"

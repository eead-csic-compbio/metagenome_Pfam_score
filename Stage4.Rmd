...
for file in *.tab; do perl /home/val/github/metagenome_Pfam_score/scripts/entropy_score.pl -input $file -size 30  -matrixdir /home/val/github/metagenome_Pfam_score/data/entropies_matrix/  > $file.30.score ; done 
